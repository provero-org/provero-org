...
const cards = [
  {
    title: "GitHub",
    description: "Follow the development, report issues, and help shape the project from day one.",
    cta: "Star on GitHub",
  ...
  {
    title: "Slack",
    description: "Join the conversation, ask questions, and connect with early adopters.",
    cta: "Join Slack",
  ...
  {
    title: "Reddit",
    description: "Discuss data quality, share feedback, and follow project updates.",
    cta: "Join r/provero",
  ...
  {
    title: "Contributing",
    description: "Read the contributing guide and submit your first pull request.",
    cta: "Read Guide",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <AnimateOnScroll>
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-6 text-lg leading-relaxed text-navy/50">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map((card, i) => (
            <AnimateOnScroll key={card.title} delay={i * 0.1}>
              <div className="group relative rounded-2xl border border-neutral-200/80 bg-white p-8 transition-all hover:shadow-xl hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-navy">
                  {card.title}
                  {card.showStars && (
                    <GitHubStars className="ml-2 text-sm font-normal text-navy/40" />
                  )}
                </h3>
